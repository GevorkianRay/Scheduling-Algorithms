...
public class HPFNP_Aging {
	...
	public static void main(String[] args) {
		...
		HPFNP_Aging hpfnp = new HPFNP_Aging(processes);
	...
	public HPFNP_Aging(ArrayList<Process> processes) {
	...
	private void execute() {
		...
		// Check the current time quanta, and add processes based on priority
		// that arrive at the current time to the q's
		while (quanta < QUANTA_MAX) {
			...
			if (!q1.isEmpty() || !q2.isEmpty() || !q3.isEmpty() || !q4.isEmpty()) {
				...
				// adds unfinished but decremented process back to its priority
				// queue
